#line 1 "C:\\Users\\copil\\Documents\\GitHub\\YamahaCommandLink\\commandlinkdash7\\commandlinkdash7.ino"
#include <Arduino.h>
#include <stdarg.h>
...
void createDashScreen() {
  ...
  lv_obj_set_style_text_font(g_ui.trim_secondary_label, &lv_font_montserrat_14, 0);
  ...
  lv_obj_set_style_text_font(g_ui.trim_start_label, &lv_font_montserrat_14, 0);
  ...
  lv_obj_set_style_text_font(g_ui.trim_end_label, &lv_font_montserrat_14, 0);
  ...
  lv_obj_set_pos(g_ui.trim_secondary_tick, bar_x - 12, secondary_y);
  lv_obj_set_pos(g_ui.trim_secondary_label, bar_x + 58, secondary_y - 8);
  lv_obj_set_pos(g_ui.trim_end_label, bar_x + 62, bar_y - 8);
  lv_obj_set_pos(g_ui.trim_start_label, bar_x + 62, bar_y + bar_h - 8);
...
#line 917 "C:\\Users\\copil\\Documents\\GitHub\\YamahaCommandLink\\commandlinkdash7\\commandlinkdash7.ino"
void setup();
#line 932 "C:\\Users\\copil\\Documents\\GitHub\\YamahaCommandLink\\commandlinkdash7\\commandlinkdash7.ino"
void loop();
#line 917 "C:\\Users\\copil\\Documents\\GitHub\\YamahaCommandLink\\commandlinkdash7\\commandlinkdash7.ino"
void setup() {
  Serial.begin(115200);
